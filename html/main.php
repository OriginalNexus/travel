...
<html lang="en" dir="ltr">
	...
	<body>
			<header class="noselect">
				<div class="leftHeader flexedContainer">	<!-- Load home when clicked -->
				...
				<i class="fas fa-sign-out-alt uiElement rightHeader"></i>
			</header>

			<!-- <div id="addTripWrapper" class="formWrapper">
				<form class="form">
					<i class="fas fa-times"></i>

					<label for="tripName">Trip name</label>
					<input type="text" class="tripName" name="tripName" placeholder="Your trip name...">

					<div class="radioWrapper">
						<p>
				    <input type="radio" id="leisure" name="radio-group" checked>
				    <label for="leisure">Leisure</label>
				  	</p>
					  <p>
					    <input type="radio" id="bussiness" name="radio-group">
			...
			<div id="addEventWrapper" class="formWrapper">
				<form class="form">
					<i class="fas fa-times"></i>

					<label for="eventName">Event name</label>
					<input type="text" class="eventName" name="eventName" placeholder="Your event name...">

					<label for="eventFrom">From</label>
					<input type="text" class="eventFrom" name="eventFrom" placeholder="From...">

					<label for="eventTo">To</label>
					<input type="text" class="eventTo" name="eventTo" placeholder="To...">

					<label for="eventLocation">Event location</label>
					<input type="text" class="eventLocation" name="eventLocation" placeholder="Your location...">
